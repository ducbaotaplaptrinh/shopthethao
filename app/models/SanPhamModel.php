...
class SanPhamModel extends Model
{
    ...
    {
        $sql = "select distinct ten_danh_muc, ten_thuong_hieu, d.duong_dan_slug as slug_dm , th.duong_dan_slug as slug_th, d.ma_danh_muc_cha, d.thu_tu_sap_xep
                from danh_muc d
                ...
                order by d.ma_danh_muc_cha, d.thu_tu_sap_xep ASC, ten_danh_muc ASC";
        $stmt = $this->conn->prepare($sql);
        $stmt->execute();
        $data = $stmt->fetchAll();
        $danhSachEntities = [];
